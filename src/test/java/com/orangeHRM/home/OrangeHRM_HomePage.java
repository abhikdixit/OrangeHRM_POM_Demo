...
import com.orangeHRM.home.OrangeHRM_UserPage;
...
public class OrangeHRM_HomePage {
	...
	public OrangeHRM_UserPage clickOnAdminTab() {
		adminTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnPIMTab() {
		PIMTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnLeaveTab() {
		LeaveTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnTimeTab() {
		TimeTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnRecruitmenTab() {
		RecruitmenTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnDetailsTab() {
		DetailsTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnPerformanceTab() {
		PerformanceTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnMaintenanceTab() {
		maintenanceTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnDirectoryTab() {
		directoryTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnDashboardTab() {
		dashboardTab.click();
		return new OrangeHRM_UserPage();
	}

	public OrangeHRM_UserPage clickOnBuzzTab() {
		BuzzTab.click();
		return new OrangeHRM_UserPage();
	}
