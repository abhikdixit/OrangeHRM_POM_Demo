...
public class OrangeHRM_DataBase {
	...
	private void ConnectToDB() throws SQLException, ClassNotFoundException {
		...
		String dbURL = "jdbc:mysql://localhost:3306/employeedb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
	...
	public Object[][] getDatafromDB() throws SQLException, ClassNotFoundException {
		...
		String rows = "select count(*) from employeedb.employee;";
		int rowsCount = 0;

		// Query to Counting Columns
		String columns = "SELECT COUNT(*) FROM INFORMATION_SCHEMA. COLUMNS WHERE table_schema = 'employeedb' AND table_name = 'employee';";
		int columnsCount = 0;
